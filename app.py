...
dtotal=pd.read_json('EV-sales-data/dtotal.json', orient='records')
...
def update_y_timeseries(hoverData,value):
    n=pd.read_json('EV-sales-data/'hoverData['points'][0]['location']+'_data.json', orient='records')
...
>>>>>>> e1d780e26adfdfe611f64e0b778b5bdac66adbb1
